...
namespace Tyuiu.Vranesko.Lab3.Review.V7
{
    internal class Program
    {
        ...
        static void OptionFS()
        {
            ...
            Console.WriteLine(" Программу разработал Вранеско Илья Николаевич | МКМб-22-1 | ТИУ 2024");
            Console.SetCursorPosition(0, 22);
            Console.WriteLine("------------------------------------------------------------------------------");
        ...
        static void drawMainMenu()
        {
            ...
            Console.WriteLine("║                     Выполнил Вранеско Илья Николаевич                     ║");
